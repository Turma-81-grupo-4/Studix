package com.generation.studix.controller;
...
import com.generation.studix.repository.CategoriaRepository;
import com.generation.studix.repository.CursoRepository;
import com.generation.studix.service.CursoService;
...
public class CursoController {
	...
	public ResponseEntity<List<Curso>> getAll() {
		...
		for (Curso curso : cursos) {
			cursoService.verificarDisponibilidade(curso);
		}
